...
$html=$html.'</TABLE>
<IMG SRC="../../img/itcs2.png" width="200px" height="40px"><br>

<table>
<tr>
	<td><strong>Shop no:1 Masrani lane Halav Pool kurla(west) Mumbai-400070</strong></td>
</tr>
</table>
...
define('_MPDF_PATH','../');
include("../mpdf.php");
$mpdf=new mPDF('c','A4-L','','',25,10,10,10,10,10,'L'); 
