  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
		...
		<TR>
			<TD>Name</TD>
			<TD><INPUT TYPE="text" NAME="customer_name" class="form-control" name="name" required ></TD>
		</TR>
		<TR>
			<TD>Email</TD>
		...
		<TR>
			<TD>Contact</TD>
			<TD>
				<INPUT TYPE="text" pattern="^\d{10}$" maxlength="10" type="phone" NAME="customer_contact" class="form-control" required></TD>
		</TR>
		<TR>
			<TD>Home Address</TD>
