  ...
  <body>
    ...
    <!-- Navigation -->
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="../index.php"><IMG src="../img/itcs2.png" class="img img-responsive" style="height:40px;width:240px;"></a>
    ...
    <footer class="py-2 bg-dark fixed-bottom">
      <div class="container">
        <p class="m-0 text-center text-white">Copyright &copy; cakenation 2019</p>
      </div>
      <!-- /.container -->
    </footer>
